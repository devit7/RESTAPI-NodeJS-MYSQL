...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2020 at 05:04 AM
...
('S2', 'Devit', 'indo', '888', 'banyak', '9d20b49f8cf0c79ce7b44b2ef69f51df');
...
('SD12', 'NG123', 'Toyota', 'van', 'Silver', '2004', 150000, 'bagus');
...
ALTER TABLE `sewa`
  ...
  ADD KEY `id_mobil` (`id_mobil`,`id_pelanggan`),
...
--
ALTER TABLE `sewa`
  ADD CONSTRAINT `sewa_ibfk_1` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sewa_ibfk_3` FOREIGN KEY (`id_karyawan`) REFERENCES `karyawan` (`id_karyawan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sewa_ibfk_4` FOREIGN KEY (`id_mobil`) REFERENCES `mobil` (`id_mobil`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
