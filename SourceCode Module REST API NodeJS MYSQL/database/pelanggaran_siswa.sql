...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2020 at 06:57 AM
...
(2, 'devit', 'nzxt', '9c071e36d2ddb5d2b9e364b61b2b42bc');
...
ALTER TABLE `pelanggaran_siswa`
  ...
  ADD CONSTRAINT `pelanggaran_siswa_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
